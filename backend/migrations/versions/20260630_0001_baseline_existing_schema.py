...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX IF NOT EXISTS idx_trades_account_status ON trades(account_id, status)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_trades_symbol ON trades(symbol)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_trades_close_time ON trades(close_time)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_alerts_created_at ON alerts(created_at DESC)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_rules_code ON rules(code)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_rule_evaluations_account_checked_at ON rule_evaluations(account_id, checked_at DESC)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_rule_violations_rule_code ON rule_violations(rule_code)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_pre_trade_checks_created_at ON pre_trade_checks(created_at DESC)")
    op.execute("CREATE INDEX IF NOT EXISTS idx_pre_trade_checks_allowed ON pre_trade_checks(allowed)")
