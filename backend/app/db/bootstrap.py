...
SCHEMA_STATEMENTS = [
    ...
    "ALTER TABLE trades ADD COLUMN IF NOT EXISTS journal_link TEXT",
    "ALTER TABLE trades ADD COLUMN IF NOT EXISTS journal_entry_mode VARCHAR(16)",
    "UPDATE trades SET journal_entry_mode = 'screenshots' WHERE journal_entry_mode IS NULL",
    "ALTER TABLE trades ALTER COLUMN journal_entry_mode SET DEFAULT 'notion'",
    "ALTER TABLE trades ALTER COLUMN journal_entry_mode SET NOT NULL",
